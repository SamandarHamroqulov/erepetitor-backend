...
const dashboardChartsRouter = require("./dashboard.charts.routes");
const dashboardReminderRouter = require("./dashboard.reminder.routes");
...
router.use("/dashboard",       dashboardChartsRouter);
router.use("/dashboard",       dashboardReminderRouter);
